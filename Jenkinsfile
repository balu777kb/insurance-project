node{
    ...
    stage('git code checkout'){
        try{
            ...
            ${BUILD_URL}''', subject: 'Job ${JOB_NAME} ${BUILD_NUMBER} is failed', to: 'balu777kb@gmail.com'
        }
    }
    ...
    stage('Containerize the application'){
        ...
        sh "${dockerCMD} build -t balu123/insure-me:${tagName} ."
    }
    ...
    stage('Pushing it ot the DockerHub'){
        ...
        sh "${dockerCMD} push balu777kb/insure-me:${tagName}"
